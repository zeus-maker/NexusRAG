...
|---|-------------|-------------|----------|-----------|---------|--------|
| 1 | 首页工作台 | `/` | ✅ §10.2（含排行榜 US-1.9） | 🟢 `Home.tsx` | 复用 `pages/home` | P0 |
...
| 9 | 评测中心 | — | ✅ §5 + §11.5 | 🟢 EvalSubNav 7 Tab | RAG 3.0 新增 | P0 |
| 10 | 系统管理 | `/admin`, `/user-setting` | ✅ §6 + §10.8 | 🟡 基础子页 | 合并 `/system/*` | P0 |
...
| 20 | 权限 | me/team | ✅ §3.10 | 🔗 Soon | 团队权限+Chunk ACL | P0 |
| 21 | 配置入口 | configuration | ✅ §10.4 | 🟢 | 侧栏「配置」 | P0 |
| 22 | 回收站 | — | ✅ §3.7 | 🟢 | US-1.8 | P1 |
| 23 | 导出任务 | — | ✅ §3.8 | ⚪ | US-1.7 | P1 |
| 24 | 外部数据源 | LinkDataSource | ✅ §10.10.1 + §10.8 | 🟡 配置 Tab | US-1.10 | **P0** |
...
| 29 | 四分类器 + 子配置 | §11.3.1–11.3.6 + API | `/system/classifier` | P1 |
...
## 8. rag3-bolt-v1.5 原型已落地组件（2026-06-06）

> 明细见 **`前端原型实现进度.md`**；Devlog：`docs/devlog/2026-06-06-rag3-frontend.md` §1–§9。
...
| Query Trace（对话内嵌） | §7.9 | `pages/Chat.tsx` | 🟢 |
| MetadataFilter（Search 设置） | §7.17 | `SearchSettingsPanel` | 🟢 |

**下一批 P0**：§10.5 多通道检索深化 · §3.10 权限页 · §11.8 融合配置路由。
