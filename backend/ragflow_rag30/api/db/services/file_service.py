...
class FileService(CommonService):
    ...
    def upload_document(
        ...
        from api.utils.api_utils import deep_merge
        ...
        if parser_config_override and isinstance(parser_config_override, dict):
            merged_parser_config = deep_merge(base_parser_config, parser_config_override)
        else:
            merged_parser_config = base_parser_config
        default_parser_id = chunk_method_override or kb.parser_id
        ...
        for file in file_objs:
            ...
            try:
                ...
                doc = {
                    "id": doc_id,
                    "kb_id": kb.id,
                    "parser_id": self.get_parser(filetype, filename, default_parser_id),
